...
define gui.main_menu_background = "gui/bg.jpg"
...
define gui.namebox_padding = (50, 20, 50, 20)
...
# mouse configs
define config.mouse = {}
define config.mouse['default'] = [("gui/mouse 6.png", 0,0)]
define config.mouse['pressed_default'] = [
    ("gui/mouse 1.png", 0,0),
    ("gui/mouse 2.png", 0,0),
    ("gui/mouse 3.png", 0,0),
    ("gui/mouse 4.png", 0,0)]
define config.mouse['button'] = [ ( "gui/mouse-hand.png", 0, 0) ]
define config.mouse['pressed_button'] = [ ( "gui/mouse-hand-click.png", 0, 0) ]
define config.mouse['menu'] = [("gui/mouse-espada.png", 0, 0)]
